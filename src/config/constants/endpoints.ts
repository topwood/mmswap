...
export const INFO_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.ETHEREUM_ETHW]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exhange-eth',
}
...
export const BLOCKS_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.ETHEREUM_ETHW]: 'https://api.thegraph.com/subgraphs/name/blocklytics/ethereum-blocks',
}
