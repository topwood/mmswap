...
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH, WBTC_ETHW, DAI_ETHW } from '@pancakeswap/tokens'
import { ChainMap, ChainTokenList } from './types'

export const ROUTER_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '0xEfF92A263d31888d860bD50809A8D171709b7b1c',
  [ChainId.ETHEREUM_ETHW]: '0xDD49935eb759D9288a6BC557569F64c3296907ce', // '0x78A4c8276b0ff5813Bb20f239D3264c5A4F6e217',
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.ETHEREUM_ETHW]: [WNATIVE[ChainId.ETHEREUM_ETHW], USDC[ChainId.ETHEREUM_ETHW], USDT[ChainId.ETHEREUM_ETHW], WBTC_ETHW],
...
export const CUSTOM_BASES: { [chainId in ChainId]?: { [tokenAddress: string]: Token[] } } = {
  ...
  [ChainId.ETHEREUM_ETHW]: {
    [WNATIVE[ChainId.ETHEREUM_ETHW].address]: [DAI_ETHW]
  },
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.ETHEREUM_ETHW]: [USDC[ChainId.ETHEREUM_ETHW], USDT[ChainId.ETHEREUM_ETHW], WNATIVE[ChainId.ETHEREUM_ETHW], WBTC_ETHW],
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.ETHEREUM_ETHW]: [USDC[ChainId.ETHEREUM_ETHW], WNATIVE[ChainId.ETHEREUM_ETHW], USDT[ChainId.ETHEREUM_ETHW], WBTC_ETHW],
  [ChainId.RINKEBY]: [USDC[ChainId.RINKEBY], WNATIVE[ChainId.RINKEBY], BUSD[ChainId.RINKEBY]],
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.ETHEREUM_ETHW]: [
    [WNATIVE[ChainId.ETHEREUM_ETHW], USDC[ChainId.ETHEREUM_ETHW]],
    [WBTC_ETHW, WNATIVE[ChainId.ETHEREUM_ETHW]],
    [WNATIVE[ChainId.ETHEREUM_ETHW], USDT[ChainId.ETHEREUM_ETHW]],
  ],
  [ChainId.BSC]: [
