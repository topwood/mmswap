...
export const USDC_ETHW = new Token(ChainId.ETHEREUM_ETHW, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 6, 'USDC', 'USD Coin')
...
export const BUSD: Record<ChainId, Token> = {
  ...
  [ChainId.ETHEREUM_ETHW]: BUSD_ETHW,
...
export const USDC = {
  ...
  [ChainId.ETHEREUM_ETHW]: USDC_ETHW,
...
export const USDT = {
  ...
  [ChainId.ETHEREUM_ETHW]: USDT_ETHW,
}
